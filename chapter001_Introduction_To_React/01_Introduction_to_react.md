...
Instead of style object using regular styling method is more easy than the one above. Now, let us use internal style to style all the JSX. It is also possible to use external styling method. [Live on code pen](https://codepen.io/Aytekin-Kaplan/pen/ZEdvggq)
      ...
      const header = (
        <header>
          <div className="header-wrapper">
            ...
            <p>Instructor: Aytekin Kaplan</p>
            <small>Date: August 17, 2024</small>
          </div>
        </header>
      );
      // JSX element, main
...
![Rendering JSX](./images/rendering_jsx6.png)
...
const authorFirstName = "Aytekin";
const authorLastName = "Kaplan";
...
Now, let us put everything together. Here, in the example below, the data is injected dynamically to the JSX. [Live on code pen](https://codepen.io/Aytekin-Kaplan/pen/WNqMeGz)
...
![Removing the warning ](./images/rendering_jsx9.png)
