...
If you do not feel comfortable with data types check the following [link](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures)
...
const names = ["Aytekin", "Murat", "Ebrar", "Burak"];
console.log(names.toString()); // Aytekin,Murat,Ebrar,Burak
```
...
console.log(names.join()); // Aytekin,Murat,Ebrar,Burak
console.log(names.join("")); // AytekinMuratEbrarBurak
console.log(names.join(" ")); // Aytekin Murat Ebrar Burak
console.log(names.join(", ")); // Aytekin, Murat, Ebrar, Burak
console.log(names.join(" # ")); // Aytekin # Murat # Ebrar # Burak
...
```js
const arrayWithFiveElements = Array(5);
...
```js
arrayWithFiveElements[0] = 1;
arrayWithFiveElements[1] = 2;
arrayWithFiveElements[2] = 3;
arrayWithFiveElements[3] = 4;
arrayWithFiveElements[4] = 5;

const firstItem = arrayWithFiveElements[0];
const middleItem = arrayWithFiveElements[arrayWithFiveElements.length / 2 - 1];
